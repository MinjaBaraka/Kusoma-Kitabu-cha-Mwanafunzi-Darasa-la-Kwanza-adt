# Kusoma: Kitabu cha Mwanafunzi, Darasa la Kwanza — ADT Bundle Reference
...
**Kusoma: Kitabu cha Mwanafunzi, Darasa la Kwanza** — Hiki ni kitabu cha Kusoma cha mwanafunzi wa Darasa la Kwanza kilichoandaliwa na Taasisi ya Elimu Tanzania, hivyo kinatoka Tanzania na kimeandikwa kwa Kiswahili. Kinalenga watoto wa mwanzo wa elimu ya msingi, kikifundisha hatua kwa hatua utambuzi wa sauti na herufi, uundaji wa silabi na maneno, herufi kubwa na ndogo, pamoja na kusoma na kusikiliza kwa ufahamu. Mtazamo wake wa ufundishaji ni wa mazoezi mengi, matumizi ya picha, kusoma kwa sauti, na hadithi fupi zinazojenga ufasaha, uelewa, maadili, na uzoefu wa maisha ya kila siku.
...
```
KUSOMA-DRS-1---18-9-2025--DUMMY-FINAL/
├── adt/                              # THE WEB APP
...
├── KUSOMA-DRS-1---18-9-2025--DUMMY-FINAL.db                    # SQLite database (pipeline state)
├── KUSOMA-DRS-1---18-9-2025--DUMMY-FINAL.pdf                   # Original source PDF
...
[
  ...
  { "section_id": "pg007_sec001", "href": "pg007_sec001.html", "page_number": 1 }
]
```
...
```json
{
  "title": "Kusoma: Kitabu cha Mwanafunzi, Darasa la Kwanza",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "sw-TZ"
...
| Original PDF | `KUSOMA-DRS-1---18-9-2025--DUMMY-FINAL.pdf` |
| Pipeline database | `KUSOMA-DRS-1---18-9-2025--DUMMY-FINAL.db` (SQLite) |
